                                        ...
                                        <tr> <th width="50%">游戏模式UDP中继服务器</th>
                                            ...
                                            <td>
                                                <select name="ss_run_mode" class="input" style="width: 145px;">   
                                                    <option value="gfw" >列表黑名单</option>
                                                    <option value="router" >大陆白名单</option>
													<option value="all" >全局模式</option>
													<option value="oversea" >海外回国</option>
                                                </select>
                                            </td>
                                        </tr>
                                    ...
                                    <td style="border: 0 none; padding: 0px;"><center><input name="button" type="button" class="btn btn-primary" style="width: 219px" onclick="applyRule();" value="应用设置"/></center></td>
                                        ...
                                        <tr> <th width="50%">服务器端口</th>
                                         ...
                                         <tr id="row_v2_aid" style="display:none;"> <th width="50%">AlterId</th>
                                            <td>
                                                <input type="text" maxlength="6" class="input" size="15" name="v2_aid_x_0" style="width: 145px" value="<% nvram_get_x("","v2_aid_x_0"); %>" />
                                            </td>
                                        </tr>
										 <tr id="row_v2_vid" style="display:none;"> <th width="50%">VmessId (UUID)</th>
                                            <td>
                                                <input type="text" maxlength="6" class="input" size="15" name="v2_vid" style="width: 145px" value="<% nvram_get_x("","v2_vid_x_0"); %>" />
                                            </td>
                                        </tr>
										 ...
										 <tr id="row_v2_net" style="display:none;"> <th width="50%">传输方式</th>
                                            <td>
                                                <select name="v2_net_x_0" class="input" style="width: 200px;">   
                                            ...
                                            <td>
                                                <select name="v2_type_x_0" class="input" style="width: 200px;">   
                                            ...
                                            <td>
                                                ...
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="v2_tls_x_0" id="v2_tls_1" <% nvram_match_x("", "v2_tls_x_0", "1", "checked"); %>><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="v2_tls_x_0" id="v2_tls_0" <% nvram_match_x("", "v2_tls_x_0", "0", "checked"); %>><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
